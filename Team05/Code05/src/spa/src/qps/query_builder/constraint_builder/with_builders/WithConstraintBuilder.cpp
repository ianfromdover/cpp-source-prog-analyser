...
void WithConstraintBuilder::addPatternClause(std::shared_ptr<WithClause> withClause, shared_ptr<QueryObject> qo) {
    ...
    arg1 = createWithArgument(withClause->getSecondArg(), withClause->getSecondArgType(), withClause->getSecondArgAttributeNoException(), qo);
