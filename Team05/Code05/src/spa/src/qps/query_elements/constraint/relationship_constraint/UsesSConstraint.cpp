...
Table UsesSConstraint::getTableWithDefaultHeadersFromPkb(QueryPkbVirtual &pkb) {
    auto t = pkb.getUsesSTable();
...
std::vector<std::string> UsesSConstraint::getDefaultHeaders() {
    return {HEADER_USESSLHS, HEADER_USESSRHS};
}
