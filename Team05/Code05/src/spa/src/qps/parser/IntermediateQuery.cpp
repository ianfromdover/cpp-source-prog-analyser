...
void IntermediateQuery::addDeclaration(qps::TokenType::TypeInfo type, const std::string& synonym) {
...
std::map<std::string, qps::TokenType::TypeInfo> IntermediateQuery::getSynonymTypeMap() {
