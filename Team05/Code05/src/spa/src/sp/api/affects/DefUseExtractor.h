...
private:
    void resetExtractor();
    void extractDefsUsesCallsFromCFG(const std::shared_ptr<CFG>& cfg);
    void extractDefsFromCalls();
...
private:
    // Uncomment to generalize Affects to support non-assignment statements.
