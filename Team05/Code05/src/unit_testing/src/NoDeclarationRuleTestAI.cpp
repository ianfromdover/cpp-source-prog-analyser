...
TEST_CASE("noDeclarationRule_AllEntitiesDeclaredOnce_returnsNoString") {
    ...
    auto *e1 = new StatementEntity();
    auto *e2 = new PrintEntity();
...
//    ParentTConstraint constraint(e1, e1); // Adding e1 again
//    NoDeclarationRule rule;
//    REQUIRE(rule.validate(qo) == VALIDATION_RULE_NO_DECLARATION);
//}
//
...
//    auto *e1 = new StatementEntity();
//    auto *e2 = new StatementEntity();
//    ParentConstraint constraint(e1, e2); // e1 is not declared in qo
//    NoDeclarationRule rule;
//    REQUIRE(rule.validate(qo) == VALIDATION_RULE_NO_DECLARATION);
//}